...
interface comissaoType {
  ...
  parcelas_comissao: ParcelasComissionType[]
}

type PlanilhasHistoricoType = {
  active: 0 | 1
  arquivo: string
  core_request_id: string | null
  id: number | string
  identifica_documento: "comissão"
  identifica_documento_id: number | string  
...
type ParcelasUserComissionType = {
  "porcentagem_real": string | null,
  ...
  tipo_laudo_opcionista: string | null
  tipo_laudo_opcionista_label: string | null
}

type ParcelasComissionType = {
  "id": string | number,
  "processo_id": string | number,
  "comissao_id": string | number,
  ...
  "corretores_vendedores": ParcelasUserComissionType[],
  "corretores_opcionistas": ParcelasUserComissionType[],
  "gerentes": ParcelasUserComissionType[],
  "gerentes_gerais": ParcelasUserComissionType[],
  "diretores_gerais": ParcelasUserComissionType[],
  "repasse_franquias": ParcelasUserComissionType[],
  "royalties": ParcelasUserComissionType,
  "comunicacao": ParcelasUserComissionType,
  "empresas": ParcelasUserComissionType[],
  "planilha_id": string   
  planilhas: PlanilhasHistoricoType[]
}

export type { comissaoType, comissaoEnvolvidos, dadosRepasseType, ParcelasComissionType, ParcelasUserComissionType, PlanilhasHistoricoType }