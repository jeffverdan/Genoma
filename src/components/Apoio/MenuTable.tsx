...
export default function MenuTableApoio(props: Props) {
    const { id, startIcon, label, className } = props;
    ...
    return (
        <div className={className}>
            ...
            >
                ...
                <MenuItem onClick={() => handleMenu(`planilha-comissao`)} className='' > <ListItemIcon> <HiPencil /> </ListItemIcon>  Ver planilhas </MenuItem>
                <MenuItem onClick={() => handleMenu(`detalhes-processo`)} className='green' ><ListItemIcon> <InformationCircleIcon width={20} height={20} /> </ListItemIcon>  Ver detalhes </MenuItem>
            </Menu>
