...
import DadosLoginLeitura from '@/components/MeuPerfil/DadosLogin/Leitura/Senha';
import DadosLoginEditavel from '@/components/MeuPerfil/DadosLogin/Editavel/Senha';
...
export default function DadosLogin({dataPerfil, loading, setLoading, returnPerfil} : IProps) {
    const [openCorner, setOpenCorner] = useState(false);
    const [open, setOpen] = useState(false);
    const [loadingBlocks, setLoadingBlocks] = useState(false);
    const [blockSave, setBlockSave] = useState<any>([]);
    const [blocks, setBlocks] = useState([
        { name: 'login', status: false, leitura: DadosLoginLeitura, editar: DadosLoginEditavel },
