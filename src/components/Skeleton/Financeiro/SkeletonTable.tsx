...
export default function SkeletonTableComissao({ columns }: PropsType) {
        ...
        <TableBody>
            {columns.map((row, index) => (
                ...
                >
                    ...
                    <TableCell className='cursorClick' padding='none'>
                        <div className={`col-table`}>
                    ...
                    <TableCell padding='none'>
                        <div className={`col-table`}>
                            <div className='col text' style={{ width: columns[7]?.minWidth }}>
                            <Skeleton animation="wave" width="100%" />
                            </div>
                        </div>
                    </TableCell>
                    ...
                    <TableCell padding='none'>
                        <div className={`col-table ${columns.length > 10 ? 'no-pading' : ''}`}>
                            <div className='col actions' style={{ width: columns[8]?.minWidth }}>
