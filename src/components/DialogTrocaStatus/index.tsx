...
export default function DialogAlterarStatus(props: SimpleDialogProps) {
    ...
    >
      ...
      <DialogContent className='dialog-content'>
        <div className='dialog-image-content'>
          <Image src={AlterarStatusImagem} alt={'alterar status'} />
          <div className='container-text-actions'>
            <div className='text-container'>
              <h2>O status alterado foi compartilhado com a gerência!</h2>

              <span>A pessoa gerente responsável pela venda já recebeu uma notificação informando sobre a mudança de status.</span>
            </div>
