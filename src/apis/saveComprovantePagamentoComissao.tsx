...
async function SaveComprovantePagamentoComissao(props: Props) {
  const { data, setProgressBar } = props;
  const token = localStorage.getItem('token');
  let result
  console.log(data);
  
  await axiosInstance.post('salvar_comprovante_pagamento_comissao', data, {
...
export default SaveComprovantePagamentoComissao;