...
import { Chip, Table, TableBody, TableHead, TableRow, Avatar, TableCell, Link, Snackbar, Alert, Skeleton } from '@mui/material';
...
const columns = [
    ...
    { id: 'tipo_venda', label: 'Tipo', minWidth: '75px', align: 'left' },
    { id: 'novo', label: '', minWidth: '75px', align: 'center' },
...
export default function Enviadas({ rows, loading, tabIndex }: PropsData) {
    ...
    useEffect(() => {
        if (rows[0]) setIsHover(rows[0].processo_id);
    }, [rows]);
                        ...
                        {rows?.map((row, index) => {
                            return (
                                ...
                                >
                                    ...
                                    <TableCell className='cursorClick' padding='none' onClick={() => router.push(`/apoio/${row.processo_id}/planilha-comissao`)}>
                                        <div className={`col-table`}>
                                    ...
                                    <TableCell padding='none'>
                                        <div className={`col-table no-pading`}>
                                            <div className='col actions' style={{ width: columns[9]?.minWidth }}>
                                                {row.comissao_incompleta
                                                    ? <Chip size='small' className='chip red' label={'Incompleta'} />
                                    ...
                                    <TableCell padding='none'>
                                        <div className={`col-table`}>
                                            <div className='col actions' style={{ width: columns[10]?.minWidth }}>
