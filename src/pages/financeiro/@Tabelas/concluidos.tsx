...
const COLUMNS = [
    ...
    { id: 'data_conclusao', label: 'Data de conclusão', minWidth: '79px', align: 'left' },
...
export default function TableConcluidos(props: PropsType) {
    ...
    const returnRateio = (row: RowsType) => {
        ...
        const rateioTotal = `${formatoMoeda(valorPagoTotal)}`;
        const percentPago = ((valorPagoTotal / total) * 100);
        const status = percentPago >= 100 ? 'concluído' : 'em andamento';

        return { rateioTotal, percentPago, status };
    };
                                ...
                                >
                                    ...
                                    <TableCell padding='none'>
                                        <div className={`col-table`}>
                                            ...
                                            >
                                                <div className='col graph concluido' style={{ width: COLUMNS[5]?.minWidth }}>
                                                    <p>{returnRateio(row).rateioTotal}</p>
                                                    <LinearProgress variant="determinate" value={100} />
                                                    <Chip label={returnRateio(row).status} className='chip green' />
                                                </div>
                                            </TooltipClientOnly>
                                        </div>
                                    </TableCell>
